...
.pokemon-image {
    ...
    height: 300px;
    object-fit: contain;
    filter: drop-shadow(0 0 15px #6495ed80);
...
.pokemon-image:hover {
    ...
    filter: drop-shadow(0 0 20px #6495edcc);
}
...
.glow-effect {
    ...
    width: 320px;
    height: 320px;
    background: radial-gradient(circle, #6495ed4d 0%, #6495ed00 70%);
    border-radius: 50%;
    z-index: 0;
...
.change-btn {
    ...
    margin-top: 1.5rem;
    transition: all 0.3s ease;
    box-shadow: 0 4px 15px #2541b24d;
    font-weight: 500;
    letter-spacing: 1px;
...
.change-btn:hover {
    ...
    box-shadow: 0 6px 20px #2541b266;
